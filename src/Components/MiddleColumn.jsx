...
const MiddleColumn = () => {
  ...
  <div className='d-flex gap-3 justify-content-between'>
    ...
    <div className='d-flex gap-3'>
      ...
      <div className='mt-2' style={{width: "3em", height: "3em", borderRadius: "50%", backgroundImage: "url('/images/dog2.jpeg')", backgroundSize: "cover", backgroundPosition: "center", flexShrink: "0"}}></div>
  ...
  <div className='rounded-4 mt-2 w-100' style={{ aspectRatio: "43/30", maxHeight: "35em", backgroundImage: 'url("images/communityPost1.jpg")', backgroundSize: "cover", backgroundRepeat: "no-repeat" , marginLeft: "-0.5em"}}></div>
...
<div className='mt-2' style={{width: "3em", height: "3em", borderRadius: "50%", backgroundImage: "url('/images/bird1.jpeg')", backgroundSize: "cover", backgroundPosition: "center " , flexShrink: "0"}}></div>
...
<p className='mt-3 m-0 ms-2 fs-5'>What a sweet moment!</p>
  ...
  <div className='rounded-4 mt-2 w-100' style={{ aspectRatio: "43/30", maxHeight: "35em", backgroundImage: 'url("images/bird2.jpeg")', backgroundSize: "cover", backgroundRepeat: "no-repeat" , marginLeft: "-0.5em"}}></div>
