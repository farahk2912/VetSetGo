    ...
    <div className="row align-items-center">
      ...
      <div className="col-12 col-md-6">
        ...
        <p className="mt-3 text-muted">
          With VetSetGo, finding trusted care becomes effortless. Explore verified veterinary hospitals near you, discover pets waiting for a loving home, and connect with a supportive community of pet owners. Whether you’re searching for emergency care, hoping to adopt, or simply want advice, VetSetGo brings it all together simply, safely, and made for every pet lover.
        </p>
