      ...
      <div className="rounded-4 w-100 position-relative" style={{minHeight: "22rem", background: 'url("adoptionBoxPhoto.png")', backgroundSize: "cover", backgroundRepeat: "no-repeat"}}>
        <div className="d-flex flex-column h-100 justify-content-between p-3">
          ...
          <div className="d-flex justify-content-center align-items-end gap-3 flex-wrap">
            <div className="rounded-circle" style={{width: "4rem", height: "4rem", backgroundImage: 'url("Adopt2.jpg")', backgroundSize: "cover", opacity: 0.6}}></div>
            <div className="rounded-circle" style={{width: "8rem", height: "8rem", backgroundImage: 'url("Adobt1.jpeg")', backgroundSize: "cover"}}></div>
            <div className="rounded-circle" style={{width: "4rem", height: "4rem", backgroundImage: 'url("Adopt3.jpeg")', backgroundSize: "cover", opacity: 0.6}}></div>
          </div>
