  ...
  return (
    <div className='d-flex flex-column gap-3'>
      ...
      <div className='bg-light rounded-4 d-flex align-items-center p-4' style={{minHeight: "10em"}}>
        <div className='flex-shrink-0' style={{width: "5em", height: "5em", borderRadius: "50%", backgroundImage: "url('/dog1.jpeg')", backgroundSize: "cover", backgroundPosition: "center"}}></div>
        <div className='ms-3'>
